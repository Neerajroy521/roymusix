...
async function getSongs(folder) {
    currfolder = folder;
    let a = await fetch(`https://github.com/Neerajroy521/roymusix/${folder}`);
...
async function displayAlbums() {
    let a = await fetch(`https://github.com/Neerajroy521/roymusix/songs/`);
    let response = await a.text();
    let div = document.createElement("div")
    div.innerHTML = response;
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if(e.href.includes("/songs/")) {
            ...
            let a = await fetch(`https://github.com/Neerajroy521/roymusix/songs/${folder}/info.json`);
